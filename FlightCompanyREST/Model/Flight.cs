...
namespace Model
{
    public class Flight : Entity<int>
    {
        ...
        public Flight(string Destination, string DepartureDate, string DepartureTime, string Airport, int NumberOfSeats) : this(0, Destination, DepartureDate, DepartureTime, Airport, NumberOfSeats)
        {
        }
